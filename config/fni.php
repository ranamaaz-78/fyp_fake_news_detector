...
return [
    ...
    // The ML service also runs the fact-verification layer, which may call
    // Wikidata and the Google Fact Check API before responding.
    'ml_timeout' => (int) env('FNI_ML_TIMEOUT', 20),
